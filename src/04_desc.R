...
ggsave(paste0(plots_path, "asylum_applications.pdf"), height = 6, width = 10)
...
ggsave(paste0(plots_path, "sample_period.pdf"), height = 6, width = 10)
...
pdf(file = paste0(plots_path, "cor_allbus.pdf"))
...
pdf(file = paste0(plots_path, "cor_refugee.pdf"))
...
ggsave(last_plot(), file = paste0(plots_path, "worries.pdf"), width = 10, height = 7)
